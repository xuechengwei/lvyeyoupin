    ...
    _createSelect: function() {
        var curDate  = this.get('date'),
            ...
            for(var i = maxYear; i >= minYear; i--) {
                select_template['year_template'] += 
                    '<option' + (curYear == i ? selected : '') + ' value="'+ i +'">' + i + '年' + '</option>';
            }
            for(var i = minMonth; i <= maxMonth; i++) {
                select_template['month_template'] += 
                    '<option' + (curMonth == i ? selected : '') + ' value="' + this._filled(i) + '">' + this._filled(i) + '月' + '</option>';
            }
...
},
{
    ...
    SELECT_TEMPLATE:'<div class="divSelect yearSelect">' +
                        '<select class="{delegate_change}">' +
                            '{year_template}' +
                         '</select>' +
                         //'年' +
                    '</div>' +
                    '<div class="divSelect monthSelect">' +
                         '<select class="{delegate_change}">' +
                            '{month_template}' +
                         '</select>' +
                         //'月' +
